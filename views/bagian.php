      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-12">
            ...
            <a href="bagian_add.php" class="btn btn-primary btn-sm" type="button"><i class="fas fa-plus"></i> Tambah Data</a>
            </div>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
        ...
        <div class="card">
            ...
            <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td><?= $row['desc'] ?></td>
                  <td>
                    <a href="bagian_edit.php?id=<?= $row['id'] ?>" type="button" title="Edit Bagian" class="btn btn-primary btn-xs"><i class="fas fa-edit"></i></a>

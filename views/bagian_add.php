      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-12">
            ...
            <h1 class="m-0 text-dark">Buat Bagian</h1>
            </div>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    ...
    <section class="content">
      <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form action="../process/bagian/bagian_add.php" enctype="multipart/form-data" method="post">
                    <div class="row">
                    <div class="col-sm-8">
                      <!-- text input -->
                      <div class="form-group">
                        <label>Nama Bagian</label>
                        <input required type="text" class="form-control" id="nama" name="nama" placeholder="Nama Bagian">
                      </div>
                    </div>
                    <div class="col-sm-8">
                      <!-- text input -->
                      <div class="form-group">
                        ...
                        <input required type="text" class="form-control" id="no_telp" name="no_telp" placeholder="Nomor Telepon">
                      </div>
                    </div>
                    <div class="col-sm-8">
                      <!-- textarea -->
                      <div class="form-group">
                        ...
                        <textarea required class="form-control" rows="2" id="desc" name="desc" placeholder="Deskripsi Bagian"></textarea>
                      </div>
                    </div>
                    <div class="col-sm-8 pt-2">
                        <button type="submit" id="add_bagian" name="add_bagian" class="btn btn-primary btn-sm" title="Submit Bagian">Buat bagian</button>

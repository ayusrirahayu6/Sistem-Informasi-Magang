    ...
    <section class="content">
      <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form action="../process/lowongan/lowongan_add.php" enctype="multipart/form-data" method="post">
                    <div class="row">
                    <div class="col-sm-8">
                      <!-- text input -->
                      <div class="form-group">
                        <label>Nama Lowongan</label>
                        <input required type="text" class="form-control" id="nama_low" name="nama_low" placeholder="Nama Lowongan">
                      </div>
                    </div>
                    <div class="col-sm-8">
                      <!-- text input -->
                    ...
                    <div class="col-sm-8">
                      ...
                      <div class="form-group">
                        <label>Kuota</label>
                        <input required type="number" min="1" class="form-control" id="kuota" name="kuota" placeholder="Kuota Lowongan">
                      </div>
                    </div>
                    <div class="col-sm-8 pt-2">
                        <button type="submit" id="add_lowongan" name="add_lowongan" class="btn btn-primary btn-sm" title="Submit Pengumuman">Buat Lowongan</button>

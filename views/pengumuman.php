      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-12">
            ...
            <h1 class="m-0 text-dark">Daftar Pengumuman</h1>
            <a href="pengumuman_add.php" class="btn btn-primary btn-sm" type="button" ><i class="fas fa-plus"></i> Tambah Data</a>
            </div>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
            ...
            <div class="card-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td><?= $row['desc'] ?></td>
                  <td>
                    <a href="pengumuman_edit.php?idpengumuman=<?=$row['id']?>" type="button" title="Edit Pengumuman" class="btn btn-primary btn-xs"><i class="fas fa-edit"></i></a>
                    <button type="button" title="Delete Pengumuman" class="btn btn-danger btn-xs" onclick="test(<?= $row['id']?>)"><i class="fas fa-trash"></i></button>
                </td>
                </tr>
                <?php } ?>
                </tbody>
...
<script type="text/javascript">
    function test(id_peng){
        ...
        if (result.value) {
          $.ajax({
            type  : "POST",
            url   : "../process/hapus_pengumuman.php",
            data  : {
              idpengumuman : id_peng,
            },

    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <div class="row"></div>
            <h1 class="m-0 text-dark">Data Peserta Magang</h1>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    </div>
        ...
        <div class="card">
            ...
            <div class="card-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                <?php
                $datauser = "SELECT a.id as idlamaran,b.*,c.* FROM `lamaran` a JOIN daftar b ON a.id_user = b.id_daftar JOIN info_magang c ON a.id_lowongan = c.id WHERE a.status = 1;";
                $i = 1;
                ...
                <tr>
                  ...
                  <td><?= $row['nama'] ?></td>
                  <td>
                    <a href="peserta_detail.php?id=<?= $row['idlamaran']?>" type="button" title="Detail Peserta" class="btn btn-primary btn-xs"><i class="fas fa-eye"></i></a>
                    <button type="button" title="Delete Peserta" class="btn btn-danger btn-xs" onclick="test(<?= $row['id_daftar']?>)"><i class="fas fa-trash"></i></button>
                </td>
                </tr>
                <?php } 
                }else{?>
                <tr>
                  <td colspan="9">Data Peserta Tidak Tersedia</td>
                </tr>
                <?php } ?>
                </tbody>
              </table>

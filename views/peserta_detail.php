  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-12">
            <h1 class="m-0 text-dark">Detail Peserta Magang</h1>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    </div>
    ...
    <section class="content">
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <div class="card card-primary">
                    <div class="card-header">
                        <h3 class="card-title">Data Peserta Magang</h3>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                        <div class="row">
            ...
            <a href="peserta.php" type="button" class="btn btn-primary btn-sm">Kembali</a>
            </div>
      <!-- /.row -->
    </section>
        </div>
